...
import { ArrowRight, Download, Github, Linkedin, Mail, Phone, MapPin, Send } from "lucide-react"
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <main id="main-content" role="main">
        {/* Hero Section */}
        <section id="home" className="py-20 text-center star-wars-hero">
        <div className="mx-auto max-w-4xl relative z-10">
          <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-6xl star-wars-title">
            {resume.profile.name}
          </h1>
          <p className="mb-8 text-xl text-cyan-400 sm:text-2xl star-wars-glow uppercase tracking-wider">
            {resume.profile.headline}
          </p>
          <p className="mb-12 text-lg leading-relaxed text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="mb-12 flex flex-wrap justify-center gap-2">
            {topSkills.map((skill) => (
              <Badge key={skill} className="star-wars-badge">
                {skill}
              </Badge>
            ))}
          </div>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center" role="group" aria-label="Main call-to-action buttons">
            <Button asChild size="lg" className="star-wars-button">
              <a href="#projects" aria-label="View my projects">
                View Projects
                <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
              </a>
            </Button>
            <Button variant="outline" size="lg" asChild className="star-wars-button">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center mt-5">
            <Button variant="outline" size="lg" asChild className="star-wars-button">
      ...
      {/* About Section */}
      <section id="about" className="py-16 star-wars-section" aria-labelledby="about-heading">
        <div className="mb-12 text-center">
          <h2 id="about-heading" className="mb-6 text-4xl font-bold star-wars-title star-wars-glow">About Me</h2>
      ...
      {/* Experience Section */}
      <section id="experience" className="py-16 star-wars-section" aria-labelledby="experience-heading">
        <div className="mb-12 text-center">
          <h2 id="experience-heading" className="mb-6 text-4xl font-bold star-wars-title star-wars-glow">Experience</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          ...
          {resume.experience.map((company, companyIndex) => (
            <div key={companyIndex} className="relative star-wars-timeline-item">
              ...
              <div className="mb-8 text-center">
                <h3 className="text-3xl font-bold star-wars-text star-wars-glow mb-2">{company.company}</h3>
      ...
      {/* Skills Section */}
      <section id="skills" className="py-16 star-wars-section" aria-labelledby="skills-heading">
        <div className="mb-12 text-center">
          <h2 id="skills-heading" className="mb-6 text-4xl font-bold star-wars-title star-wars-glow">Skills & Technologies</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
      ...
      {/* Projects Section */}
      <section id="projects" className="py-16 star-wars-section" aria-labelledby="projects-heading">
        <div className="mb-12 text-center">
          <h2 id="projects-heading" className="mb-6 text-4xl font-bold star-wars-title star-wars-glow">Featured Projects</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {resume.projects.slice(0, 6).map((project) => (
            <Card key={project.slug} className="star-wars-card group star-wars-space hover:scale-[1.02] transition-transform duration-300">
              <CardHeader>
                <CardTitle className="group-hover:text-cyan-400 transition-colors star-wars-text">
                  {project.name}
                </CardTitle>
              ...
              <CardContent>
                ...
                <div className="mt-4 flex gap-2">
                  {project.links.github && (
                    <Button variant="ghost" size="sm" className="star-wars-button" asChild>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 star-wars-section" aria-labelledby="contact-heading">
        <div className="mb-12 text-center">
          <h2 id="contact-heading" className="mb-6 text-4xl font-bold star-wars-title star-wars-glow">Get In Touch</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <Card className="star-wars-card group hover:scale-[1.01] transition-transform duration-300">
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 star-wars-form" aria-label="Contact form">
                <div className="space-y-2">
                ...
                <Button 
                  ...
                  className="w-full star-wars-button text-lg py-3"
